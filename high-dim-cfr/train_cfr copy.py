...
def run_master():
    ...
    # Auto-scale workers to max out the node safely
    ...
    torch.save(master_model.state_dict(), "pokerastinot_v100_final.pth")
    print("💾 Model saved to 'pokerastinot_v100_final.pth' successfully.")
